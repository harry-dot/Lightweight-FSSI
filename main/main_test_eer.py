...
pmp = '/data/hqs/lightweight_spk_rec/Exp/libri_logger/ESBPGnet_subband_Ls_0.01Le/7s_10w1s_new/BEST_MODEL'
# pmp = '/home/ch/pycharm/venv/研二/IEEE/lib_logger/ESBPGnet3/7w5svox1/BEST_MODEL/BEST_MODEL'
logger = '/data/hqs/lightweight_spk_rec/Exp/libri_logger/ESBPGnet_subband_Ls_0.01Le/Vox1_test_7s_eer/7s_10w1s_test.log'

#tr_path= '/data/datasets/FSSV_feature/Vox2/Vox2_7s/train'
# ts_path = '/data/ch/FSSV_feature/Vox_test/Vox7_test'
# val_path = '/data/ch/FSSV_feature/Vox_test/Vox7_test'
#ts_path = '/data/datasets/FSSV_feature/Vox2/Vox2_1s/test'
#val_path = '/data/datasets/FSSV_feature/Vox2/Vox2_1s/test'
#mean_root = '/data/datasets/FSSV_feature/Vox2/Vox2_1s/tr_mean_std/mean.npy'
#std_root = '/data/datasets/FSSV_feature/Vox2/Vox2_1s/tr_mean_std/std.npy'
...
parser.add_argument('--val_dir',  default="/data/datasets/FSSV_feature/data_list/lib.txt",   type=str,   help='[net] logger path')
