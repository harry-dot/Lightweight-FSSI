...
#tr_path= '/data/datasets/FSSV_feature/Vox/Vox1s/train'
#ts_path = '/data/datasets/FSSV_feature/Vox/Vox1s/test'
#val_path = '/data/datasets/FSSV_feature/Vox/Vox1s/test'
#mean_root = '/data/datasets/FSSV_feature/Vox/Vox1s/tr_mean_std/mean.npy'
#std_root = '/data/datasets/FSSV_feature/Vox/Vox1s/tr_mean_std/std.npy'

#tr_path= '/data/datasets/FSSV_feature/Lib2/Lib1s/train'
#ts_path = '/data/datasets/FSSV_feature/Lib2/Lib1s/test'
#val_path = '/data/datasets/FSSV_feature/Lib2/Lib1s/test'
#mean_root = '/data/datasets/FSSV_feature/Lib2/Lib1s/tr_mean_std/mean.npy'
#std_root = '/data/datasets/FSSV_feature/Lib2/Lib1s/tr_mean_std/std.npy'
...
# parser.add_argument('--lr',   default=0.0000006,   type=float, help='[net] learning rate')
...
#parser.add_argument('--theta',  default=1e-3,   type=float,   help='[net] weight of sisnr loss')
parser.add_argument('--theta',  default=0.01,   type=float,   help='[net] weight of sisnr loss')
#parser.add_argument('--theta',  default=1.0,   type=float,   help='[net] weight of sisnr loss')
parser.add_argument('--train_method',  default='meta',   type=str,   help='[net] weight of sisnr loss')
